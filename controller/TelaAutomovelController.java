...
/*=====================================================================================*/
    ...
    void cadastrarNovoCarro(ActionEvent event) {
        ...
        bo.inserir(vo);
        tableAutomoveis.setItems(FXCollections.observableArrayList(
            bo.buscarPorPlaca(vo)
        ));
    ...
    void pesquisarDono(ActionEvent event) {
        ...
        if (dono.isBlank() || dono == null) {
            ...
            tableAutomoveis.setItems(FXCollections.observableArrayList(
                boautomovel.buscarPorDono(vo2.getCliente())
            ));
        }
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        placaCol.setCellValueFactory(
            new Callback <CellDataFeatures<AutomovelVO,String>, ObservableValue<String>>() {    
                @Override    
